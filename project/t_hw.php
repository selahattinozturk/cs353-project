...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!$result && !$result1) {
        ...
        echo "<script LANGUAGE='JavaScript'>
            ...
            window.location.href = 't_assign_hw.php'; 
        </script>";
    }
    ...
    <div class="panel container-fluid">
        ...
        while($resultss = mysqli_fetch_array($result)) {
            ...
            echo "<td> <form action=\"\" METHOD=\"POST\">
                    <button href=\"t_assign_hw.php\" type=\"submit\" name = \"given_cid\"class=\"btn btn-success btn-sm\" value =".$resultss['cid'] .">Assign</button>
                    </form>
