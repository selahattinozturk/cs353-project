...
<div class="container">
    ...
    <div class="panel container-fluid">
        <h3 class="page-header" style="font-weight: bold;">Homeworks</h3>
        <?php
    ...
    <form action="" METHOD="POST">
        <div class = "form-col">
            ...
            <input class="form-control col-md-4" name="cid"  type="text"  placeholder="Enter grade">
            <button class="btn btn-primary" type="submit" >Submit the application</button>
        </div>
    </form>

    <div class="panel container-fluid">
        <h3 class="page-header" style="font-weight: bold;">Exams</h3>
        <?php
